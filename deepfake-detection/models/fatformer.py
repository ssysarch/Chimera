...
from .clip_fat import clip
from .clip_fat.simple_tokenizer import SimpleTokenizer as _Tokenizer
...
class LanguageGuidedAlignment(nn.Module):
    ...
    def __init__(self, clip_model, classnames=["real", "fake"]):
        super().__init__()
        n_cls = len(classnames)
        n_ctx = 8  # Args.num_context_embedding
...
class CLIPModel(nn.Module):
    def __init__(self, name):
        ...
        self.clip_model = clip.load(name, device="cpu")[
            0
        ...
        self.language_guided_alignment = LanguageGuidedAlignment(
            self.clip_model,
            classnames=["real", "fake"],  # Args=Args
        )
        ...
        self.num_classes = 4  # Args.num_classes
