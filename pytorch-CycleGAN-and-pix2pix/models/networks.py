...
from .nested import UNet as UNet2
from .uformer import Uformer, UNet
...
def define_G(
    ...
    if netG == "resnet_9blocks":
        ...
        net = UnetGenerator(
            input_nc, output_nc, 4, ngf, norm_layer=norm_layer, use_dropout=use_dropout
        )
    elif netG == "unet_128":
        net = UnetGenerator(
