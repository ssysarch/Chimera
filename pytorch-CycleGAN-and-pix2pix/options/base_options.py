...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # my options
        parser.add_argument(
            "--simulator", action="store_true", help="use simulator for training"
        )
        parser.add_argument(
            "--pretrained_generator",
            action="store_true",
            help="use pretrained generator model",
        )
        parser.add_argument("--simulator_epoch", default="latest", type=str)
        parser.add_argument("--pretrained_epoch", default="latest", type=str)
        # basic parameters
        parser.add_argument("--dirA", type=str, default="A", help="A directory")
        parser.add_argument("--dirB", type=str, default="B", help="B directory")
        parser.add_argument(
            "--name",
            type=str,
